...
recent-activity-account-passkey-wrap-deleted = Acesso à sincronização de senha removido
...
recent-activity-account-passkey-wrap-deletion-failure = Falha na remoção do acesso para sincronizar a palavra-passe

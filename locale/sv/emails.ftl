...
body-android-badge = <img data-l10n-name="google-play-badge" alt="Hämta { $productName } på { -google-play }">
# Variables:
#  $productName (String) - The name of the product to be downloaded, e.g. Mozilla VPN, or Firefox
...
lowRecoveryCodes-subject-2 =
    { $numberRemaining ->
        ...
        [one] Endast en reservautentiseringskod kvar
...
passwordChangeRequired-action = Återställ lösenordet
...
postAddTwoStepAuthentication-how-protects-link = Hur detta skyddar ditt konto
postAddTwoStepAuthentication-how-protects-plaintext = Hur detta skyddar ditt konto:

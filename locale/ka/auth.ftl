...
verificationReminderFinal-description-2 = რამდენიმე კვირის წინ შექმენით { -product-mozilla-account }, მაგრამ ჯერ არ დაგიმოწმებიათ. თქვენი უსაფრთხოებისთვის ჩვენ წავშლით ანგარიშს, თუ მომდევნო 24 საათში არ დაამოწმებთ.

...
subscriptionUpgrade-content-old-price-default = წინა განაკვეთი იყო { $paymentAmountOld } ყოველ საგადასახადო შუალედში.
...
subscriptionUpgrade-content-old-price-default-tax = წინა განაკვეთი იყო { $paymentAmountOld } + { $paymentTaxOld } გადასახადი ყოველ საგადასახადო შუალედში.
...
subscriptionUpgrade-content-new-price-default = ამიერიდან ჩამოგეჭრებათ { $paymentAmountNew } ყოველ საგადასახადო შუალედში, ფასდაკლებების გამოკლებით.
...
subscriptionUpgrade-content-new-price-default-tax = ამიერიდან ჩამოგეჭრებათ { $paymentAmountNew } + { $paymentTaxNew } გადასახადი ყოველ საგადასახადო შუალედში, ფასდაკლებების გამოკლებით.

...
postAddAccountRecovery-description = თქვენ წარმატებით შექმენით აღდგენის ახალი გასაღები { -product-firefox-account(case: "gen") }თვის შემდეგი მოწყობილობის საშუალებით:

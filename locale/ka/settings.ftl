...
recent-activity-account-recovery-phone-replace-failure = აღდგენის ტელეფონის ჩანაცვლება ვერ მოხერხდა
...
recent-activity-account-recovery-phone-reset-password-complete = აღდგენის ტელეფონით პაროლის განულება შესრულებულია
...
recent-activity-account-mfa-otp-sent = მოთხოვნილია ანგარიშზე ცვლილების დამოწმოება
# The user successfully entered the code emailed to authorize a sensitive account change.
recent-activity-account-mfa-otp-verified = ანგარიშზე ცვლილება დამოწმებულია

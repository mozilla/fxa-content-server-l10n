...
postVerify-sub-title-2 = { -product-firefox-account } confirmada. Ya casi estás ahí.
...
postVerify-subject-2 = Cuenta confirmada. Ahora, sincroniza otro dispositivo para finalizar la configuración

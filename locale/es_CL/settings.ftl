...
flow-setup-phone-confirm-code-success-message = Teléfono de recuperación de respaldo añadido
...
flow-setup-phone-submit-number-info-message = El teléfono de recuperación de respaldo solo está disponible en Estados Unidos y Canadá. No se recomiendan los números de VoIP ni las máscaras telefónicas.
...
tfa-enabled-v2 = La autenticación en dos pasos ha sido activada
tfa-scan-this-code =
...
tfa-row-backup-phone-delete-restriction = Si quieres eliminar tu teléfono de recuperación de respaldo, primero añade códigos de autenticación de respaldo o deshabilita la autenticación de dos pasos para evitar el bloqueo de tu cuenta.
# "this" refers to backup recovery phone
tfa-row-backup-phone-description = Este es el método de recuperación más fácil si no puedes usar tu aplicación de autenticación.
...
inline-recovery-2fa-enabled-v2 = La autenticación en dos pasos ha sido activada
...
# tab. Firefox will attempt to send the user back to their original tab to use an email mask after
# they successfully sign in or sign up for a Mozilla account to receive a free email mask.
signin-recovery-code-desktop-relay = { -brand-firefox } intentará regresarte a la pestaña de origen para que hagas uso de una máscara de correo electrónico después de conectarte.

...
fxa-privacy-url = Ichinan Runa'oj Mozilla
...
subplat-explainer-specific = Xak'ül re taqoya'l ruma chi ri { $email } k'o jun rub'i' rutaqoya'l richin Firefox chuqa' xatz'ib'aj ab'i' richin { $productName }.
subplat-explainer-multiple = Xak'ül re taqoya'l ruma chi ri { $email } k'o jun rub'i' rutaqoya'l richin Firefox chuqa' xatz'ib'aj ab'i' pa jalajöj taq tikojil.
...
passwordChangeRequired-suspicious-activity = Xqïl itzel b'anoj pa rub'i' ataqoya'l richin Firefox. Richin man ke'ok pa rub'i' ataqoya'l richin Firefox toq man aya'on ta q'ij, yeqachüp ronojel ri rokisab'al ri rub'i' ataqoya'l chuqa' 
passwordChangeRequired-sign-in = Tatikirisaj moloj pa xab'achike okisab'äl o samaj akuchi' nawokisaj ri rub'i' ataqoya'l richin Firefox chuqa' tawojqaj ri ya'on rutzijol.
...
postAddAccountRecovery-description = Ütz xub'än xatz'ük jun kolonel ewan rutzij ri rub'i' ataqoya'l richin Firefox pa re okisab'äl re':
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = Xtzij ri jikib'anem rik'in ka'i'-xaq
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = Ütz xatzïj ri rujikib'axik pa ka'i' xaq ri rub'i' ataqoya'l richin Firefox. Wakami xtik'utüx chawe ri rub'itz'ib' rujikomal awokisaxel richin jikib'anïk toq xtatikirisaj molojri'ïl.
postAddTwoStepAuthentication-description = Ütz xub'än xatzïj ri rujikib'axik pa ka'i' xak ri rub'i' ataqoya'l richin Firefox pa re okisaxel re':
postAddTwoStepAuthentication-action = { manage-account }
postChangePrimary-subject = Xk'ex ri nab'ey taqoya'l
postChangePrimary-title = K'ak'a' nab'ey taqoya'l
postChangePrimary-description = Ütz xub'än xajäl ri nab'ey ataqoya'l pa { $email }. Wakami re ochochib'äl re' ja re' ri awinaqul richin natikirisaj molojri'ïl pa ri rub'i' Ataqo'ua'l richin Firefox chuqa' richin ye'ak'ül taq 
...
postRemoveAccountRecovery-description = Ütz xub'än xayüj jun kolonel ewan rutzij ri rub'i' ataqoya'l richin Firefox pa re okisab'äl re':
postRemoveAccountRecovery-action = { manage-account }
postRemoveSecondary-subject = Xyuj ri ruka'n taqoya'l
postRemoveSecondary-title = { postRemoveSecondary-subject }
postRemoveSecondary-description = Ütz xayüj { $secondaryEmail } achi'el jun ruka'n taqoya'l pa ri Ataqoya'l richin Firefox. Man xketaq ta chik pa re ochochib'äl re' ri taq rutzijol jikomal chuqa' kijikib'axik kitikirisaxik 
...
postRemoveTwoStepAuthentication-description = Ütz xub'än xachüp ri rujikib'axik pa ka'i' xak ri rub'i' ataqoya'l richin Firefox pa re okisaxel re':
postRemoveTwoStepAuthentication-description-plaintext = Ütz xub'än xachüp ri rujikib'axik pa ka'i' xak ri Rub'i' Ataqoya'l richin Firefox. Man xtik'utüx ta chik pe ri kib'itz'ib' jikomal toq xtatikirisaj molojri'ïl.
postRemoveTwoStepAuthentication-action = { manage-account }
postVerify-sub-title = Xjikib'äx Rub'i' Rutaqoya'l Firefox. Nak'ïs yan.
postVerify-title = ¡Wakami ke'axima' ri taq awokisab'al!
postVerify-description = Sync junam yeruk'waj ri taq ayaketal, ewan taq atzij chuqa' ch'aqa' chik rutzij Firefox pa ronojel awokisab'al.
...
verificationReminderFirst-title = Ütz apetik pa Firefox ach'alalri'ïl
verificationReminderFirst-description = Jujun kan q'ij xatz'ük jun rub'i' ataqoya'l richin Firefox, xa xe chi man xajikib'a' ta.
...
verificationReminderSecond-description = K'o chik jun wuqq'ij tatz'uk jun Rub'i' Ataqoya'l richin Firefox xa xe chi majub'ey xajikib'a'. Yatqamäy apo.
...
verify-title = Ke'atzija' ronojel ri taq rutikojil ri Firefox ach'ala'il
...
verifySecondary-explainer = Re Rutaqoya'l Firefox re' xuk'utuj chi tokisäx ri { $email } achi'el jun ruka'n rochochib'al taqoya'l: 
...
verifySecondaryCode-explainer = Re Rutaqoya'l Firefox re' xuk'utuj chi tokisäx ri { $email } achi'el jun ruka'n rochochib'al taqoya'l: 

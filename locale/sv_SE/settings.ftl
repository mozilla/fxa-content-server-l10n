...
recent-activity-account-passkey-wrap-deleted = Synkåtkomst för lösenordsnyckel har tagits bort
...
recent-activity-account-passkey-wrap-deletion-failure = Borttagning av synkroniseringsåtkomst för lösenordsnyckel misslyckades

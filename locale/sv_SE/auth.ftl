...
credit-card-ending-in = Kort { $cardName } som slutar på { $lastFour }
...
unknown-card-ending-in = Okänt kort som slutar på { $lastFour }
# Variables:
#  $invoiceNumber (String) - The invoice number of the subscription invoice, e.g. 8675309
...
subscriptionUpgrade-content-old-price-halfyear = Den tidigare avgiften var { $paymentAmountOld } per sex månader.
...
subscriptionUpgrade-content-old-price-halfyear-tax = Den tidigare avgiften var { $paymentAmountOld } + { $paymentTaxOld } moms per sex månader.
...
subscriptionUpgrade-content-new-price-halfyear = Från och med nu kommer du att debiteras { $paymentAmountNew } per sex månader, exklusive rabatter.

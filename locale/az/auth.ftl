...
postAddAccountRecovery-description = Bu cihazdan uğurla Firefox Hesabınız üçün hesab bərpa açarı törətdiniz:
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = İki mərhələli daxil olma aktivləşdirildi
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = Uğurla Firefox Hesabınız üçün iki mərhələli daxil olmanı aktivləşdirdiniz. Təsdiqləmə tətbiqinizdəki təhlükəsizlik kodları artıq hər daxil olmanızda tələb ediləcək.
...
postRemoveAccountRecovery-description = Bu cihazdan uğurla Firefox Hesabınız üçün hesab bərpa açarını sildiniz:
...
verificationReminderFirst-title = Firefox ailəsinə xoş gəldiniz
verificationReminderFirst-description = Bir neçə gün əvvəl Firefox Hesabı yaratdınız, amma hələ də təsdiqləmədiniz.

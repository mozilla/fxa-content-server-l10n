...
fxa-privacy-url = Mozilla-privacybelied
...
subplat-explainer-specific = Jo ûntfange dit berjocht omdat { $email } in Firefox-account hat en jo oanmeld binne foar { $productName }.
## Variables:
##  $email (String) - A user's primary email address
subplat-explainer-multiple = Jo ûntfange dit berjocht omdat { $email } in Firefox-account hat en jo binne abonnearre op mear produkten.
...
passwordChangeRequired-suspicious-activity = Wy hawwe fertocht gedrach yn jo Firefox-account detektearre. Om net tastiene tagong ta jo Firefox-account op te kearen, hawwe wy alle apparaten yn jo account ûntkeppele en jo moatte út foarsoarch 
passwordChangeRequired-sign-in = Meld jo opnij oan op ien fan de apparaten of services wêr't jo jo Firefox-account brûke en folgje de presintearre stappen.
...
postAddAccountRecovery-description = Jo hawwe mei sukses in kaai foar accountwerstel foar jo Firefox-account generearre fia it folgjende apparaat:
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = Twa-staps autentikaasje ynskeakele
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = Jo hawwe mei sukses twa-staps autentikaasje op jo Firefox-account ynskeakele. Fan no ôf binne by elke oanmelding de feilichheidskoaden fan jo autentikaasje-app fereaske.
postAddTwoStepAuthentication-description = Jo hawwe fan it folgjende apparaat ôf mei sukses twa-staps autentikaasje op jo Firefox-account ynskeakele:
postAddTwoStepAuthentication-action = { manage-account }
postChangePrimary-subject = Primêr e-mailadres fernijd
postChangePrimary-title = Nij primêr e-mailadres
## Variables:
##  $email (String) - A user's email address
postChangePrimary-description = Jo hawwe jo primêre e-mailadres mei sukses nei { $email } wizige. Dit adres is no jo brûkersnamme foar it oanmelden by jo Firefox-account, krekt as foar it ûntfangen fan befeiligingsmeldingen en 
...
postRemoveAccountRecovery-description = Jo hawwe mei sukses in kaai foar accountwerstel foar jo Firefox-account fuortsmiten fia it folgjende apparaat:
postRemoveAccountRecovery-action = { manage-account }
postRemoveSecondary-subject = Sekundêr e-mailadres fuortsmiten
postRemoveSecondary-title = { postRemoveSecondary-subject }
## Variables:
##  $secondaryEmail (String) - A user's email address
postRemoveSecondary-description = Jo hawwe { $secondaryEmail } mei sukses as sekundêr e-mailadres fan jo Firefox-account fuortsmiten. Befeiligingsmeldingen en oanmeldingsbefêstigingen wurde net mear op dit adres ôflevere.
...
postRemoveTwoStepAuthentication-description = Jo hawwe fan it folgjende apparaat ôf mei sukses twa-staps autentikaasje op jo Firefox-account útskeakele:
postRemoveTwoStepAuthentication-description-plaintext = Jo hawwe mei sukses twa-staps autentikaasje op jo Firefox-account útskeakele. Feilichheidskoaden sille by elke oanmelding net langer nedich wêze.
postRemoveTwoStepAuthentication-action = { manage-account }
postVerify-sub-title = Firefox-account ferifiearre. Jo binne hast klear.
postVerify-title = It folgjende: syngronisearje tusken jo apparaten!
postVerify-description = Sync hâldt op persoanlike wize jo blêdwizers, wachtwurden en oare Firefox-gegevens op al jo apparaten itselde.
...
verificationReminderFirst-title = Wolkom by de Firefox-famylje
verificationReminderFirst-description = Jo hawwe inkelde dagen lyn in Firefox-account oanmakke, mar dit nea befêstige.
...
verificationReminderSecond-description = Hast in wike lyn hawwe jo in Firefox-account oanmakke, mar nea ferifiearre. Wy meitsje ús soargen oer jo.
...
verify-title = Aktivearje de Firefox-produktfamylje
...
verifySecondary-explainer = Der is in oanfraach foar it gebrûk fan { $email } as twadde e-mailadres dien fan de folgjende Firefox-account ôf:
...
## Variables:
##  $email (string) A user's unverified secondary email address
verifySecondaryCode-explainer = Der is in oanfraach foar it gebrûk fan { $email } as twadde e-mailadres dien fan de folgjende Firefox-account ôf:

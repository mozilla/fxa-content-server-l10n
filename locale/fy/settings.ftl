...
recovery-key-download-button-v2 = Jo accountwerstelkaai downloade
    .title = Downloade
...
flow-recovery-key-confirm-pwd-heading = Fier jo wachtwurd nochris yn om te begjinnen
...
flow-recovery-key-hint-header = Geweldich! Foegje no in ûnthâldhint ta
# This message explains why saving a storage hint can be helpful. The account recovery key could be "stored" in a physical (e.g., printed) or virtual location (e.g., in a device folder or in the cloud).
flow-recovery-key-hint-message = Foegje in hint ta oer wêr’t jo jo accounteerstelkaai bewarre hawwe. Wy kinne it jo toane wylst it opnij ynstellen fan it wachtwurd om jo gegevens te werstellen.
# The label for the text input where the user types in the storage hint they want to save.
# The storage hint is optional, and users can leave this blank.
flow-recovery-key-hint-input =
    .label = Fier jo ûnthâldhint yn (opsjoneel)
...
flow-recovery-key-success-alert-no-hint = Accountwerstelkaai ynskeakele.
...
flow-recovery-key-success-alert-with-hint = Accountwerstelkaai ynskeakele en ûnthâldhint bewarre.

...
flow-setup-2a-qr-instruction = <strong>1. korak:</strong> skenirajte to kodo QR s katerokoli aplikacijo za overitev, kot je Duo ali Google Authenticator.
...
flow-setup-2fa-qr-alt-text =
    .alt = QR koda za nastavitev overjanja v dveh korakih. Skenirajte ali izberite "Ne morete prebrati kode QR?" Če želite dobiti tajni ključ za nastavitev.
flow-setup-2fa-cant-scan-qr-button = Ne morete prebrati kode QR?
flow-setup-2fa-manual-key-heading = Ročno vnesite kodo
flow-setup-2fa-manual-key-instruction = <strong>1. korak:</strong> vnesite to kodo v želeno aplikacijo za overitev.
flow-setup-2fa-scan-qr-instead-button = Želite namesto tega skenirati QR-kodo?
# links to https://support.mozilla.org/kb/secure-firefox-account-two-step-authentication#w_step-one
flow-setup-2fa-more-info-link = Preberite več o aplikacijah za overitev
...
flow-setup-2fa-backup-choice-description = To vam omogoča prijavo, če ne morete dostopati do mobilne naprave ali aplikacije za overitev.
...
flow-setup-2fa-backup-choice-phone-info = Prejmite obnovitveno kodo preko besedilnega sporočila. Trenutno na voljo v ZDA in Kanadi.
flow-setup-2fa-backup-choice-code-title = Rezervne overitvene kode
flow-setup-2fa-backup-choice-code-badge = Najbolj varen
...
product-promo-monitor-plus-cta = Začnite
...
inline-recovery-cancel-setup = Prekliči nastavitev
...
signup-heading-relay = Ustvarite geslo

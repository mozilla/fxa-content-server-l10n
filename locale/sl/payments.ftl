...
new-user-subscribe-product-updates-snp = Želim prejemati novice in obvestila o varnosti in zasebnosti iz { -brand-mozilla(sklon: "rodilnik") }
new-user-subscribe-product-updates-hubs = Želim prejemati novice in obvestila o izdelkih s strani { -product-mozilla-hubs } in { -brand-mozilla }

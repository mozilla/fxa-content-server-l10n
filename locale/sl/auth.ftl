...
passwordChangeRequired-suspicious-activity = V vašem Firefox Računu smo zaznali sumljivo dejavnost. Da bi preprečili nepooblaščen dostop do vašega Firefox Računa, smo iz njega odklopili vse naprave in iz previdnosti zahtevamo, da spremenite 
passwordChangeRequired-sign-in = Znova se prijavite v katerokoli napravo ali storitev, kjer uporabljate svoj Firefox Račun, in sledite korakom, ki vam bodo predstavljeni.
...
postAddAccountRecovery-description = Uspešno ste ustvarili obnovitveni ključ za svoj Firefox Račun z uporabo naslednje naprave:
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = Overitev v dveh korakih je omogočena
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = Uspešno ste omogočili overitev v dveh korakih za svoj Firefox Račun. Varnostne kode iz vaše aplikacije za overitev bodo odslej zahtevane ob vsaki prijavi.
postAddTwoStepAuthentication-description = Uspešno ste omogočili overitev v dveh korakih za svoj Firefox Račun z naslednje naprave:
...
postRemoveAccountRecovery-description = Uspešno ste odstranili obnovitveni ključ za svoj Firefox Račun z uporabo naslednje naprave:
...
postRemoveTwoStepAuthentication-description = Uspešno ste onemogočili overitev v dveh korakih za svoj Firefox Račun z naslednje naprave:
postRemoveTwoStepAuthentication-description-plaintext = Uspešno ste onemogočili overitev v dveh korakih za svoj Firefox Račun. Varnostne kode ne bodo več zahtevane ob vsaki prijavi.
...
verificationReminderFirst-title = Dobrodošli v družini Firefox
verificationReminderFirst-description = Pred nekaj dnevi ste ustvarili Firefox Račun, vendar ga niste nikoli potrdili.
...
verificationReminderSecond-description = Pred slabim tednom ste ustvarili Firefox Račun, vendar ga niste nikoli potrdili. Skrbi nas za vas.

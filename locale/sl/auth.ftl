...
verificationReminderSecond-second-description-3 = Vaš { -product-mozilla-account } vam omogoča sinhronizacijo vaše izkušnje s { -brand-firefox(sklon: "orodnik") } med napravami in dostop do več izdelkov { -brand-mozilla(sklon: "rodilnik") }, ki varujejo zasebnost.

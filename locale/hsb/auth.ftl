...
passwordChangeRequired-suspicious-activity = Smy podhladne zadźerženje na wašim konće Firefox zwěsćili. Zo bychmy njeawtorizowanemu přistupej k wašemu kontu Firefox zadźěwali, smy wšě graty we wašim konće dźělili a namołwjamy was, waše hesło 
passwordChangeRequired-sign-in = Přizjewće so zaso pola grata abo słužby, hdźež swoje konto Firefox wužiwaće a sćěhujće kroćele, kotrež so wam pokazuja.
...
postAddAccountRecovery-description = Sće wuspěšnje nowy wobnowjenski kluč za swoje konto Firefox z pomocu slědowaceho grata wutworił:
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = Dwukročelowa awtentifikacija zmóžnjena
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = Sće dwukročelowu awtentifikaciju na swojim konće Firefox wuspěšnje zmóžnił. Wěstotne kody z wašeho awtentifikaciskeho nałoženja su wotnětka trěbne při kóždym přizjewjenju.
postAddTwoStepAuthentication-description = Sće dwukročelowu awtentifikaciju na swojim konće Firefox ze slědowacym gratom wuspěšnje zmóžnił:
...
postRemoveAccountRecovery-description = Sće wuspěšnje nowy wobnowjenski kluč za swoje konto Firefox z pomocu slědowaceho grata wotstronił:
...
postRemoveTwoStepAuthentication-description = Sće dwukročelowu awtentifikaciju na swojim konće Firefox ze slědowacym gratom wuspěšnje znjemóžnił:
postRemoveTwoStepAuthentication-description-plaintext = Sće dwukročelowu awtentifikaciju na swojim konće Firefox wuspěšnje znjemóžnił. Wěstotne kody wotnětka při kóždym přizjewjenju hižo trěbne njejsu.
postRemoveTwoStepAuthentication-action = { manage-account }
postVerify-sub-title = Konto Firefox je přepruwowane. Sće nimale hotowy.
...
verificationReminderFirst-title = Witajće k swójbje Firefox
verificationReminderFirst-description = Před někotrymi dnjemi sće konto Firefox załožił, ale nichtó njeje jo wobkrućił.
...
verificationReminderSecond-description = Před nimale jednym tydźenjom sće konto Firefox załožił, ale njejsće jo wobkrućił. Činimy sej starosće wo was.

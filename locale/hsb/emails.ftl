...
postRemovePasskey-subject = Hesłowy kluč je so zhašał
postRemovePasskey-preview = Hesłowy kluč je so z wašeho konta wotstronił
postRemovePasskey-title = Sće swój hesłowy kluč zhašał
postRemovePasskey-description = Dyrbiće druhe metodu za přizjewjenje wužiwać.
postRemovePasskey-requested-from = Sće to požadał wot:
postRemovePasskey-action = Konto rjadować

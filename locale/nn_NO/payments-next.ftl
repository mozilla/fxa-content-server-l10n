...
subscription-content-next-bill-no-tax = Neste rekning på { $invoiceTotal } forfell den { $nextBillDate }
subscription-content-next-bill-with-tax = Neste rekning på { $invoiceTotal } + { $taxDue } moms forfell den { $nextBillDate }

...
postAddAccountRecovery-description = Ghin thu iuchair aisig dhan chunntas Firefox agad leis an uidheam a leanas:
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = Tha an dearbhadh dà-cheumnach an comas
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = Chuir thu dearbhadh dà-cheumnach an comas sa chunntas Firefox agad. Thèid còd tèarainteachd on aplacaid dearbhaidh agad iarraidh gach turas a chlàraicheas tu a-steach a-nis.
...
postRemoveAccountRecovery-description = Thug thu air falbh iuchair aisig dhan chunntas Firefox agad leis an uidheam a leanas:
...
verificationReminderFirst-title = Fàilte gu teaghlach Firefox
verificationReminderFirst-description = Chruthaich thu cunntas Firefox beagan làithean air ais ach cha do rinn thu a dhearbhadh gu ruige seo.
...
verificationReminderSecond-description = Chruthaich thu cunntas Firefox cha mhòr seachdain air ais ach cha do dhearbh thu e. Tha sin a’ cur dragh oirnn.

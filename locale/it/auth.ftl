...
postRemoveRecoveryPhone-description-v2 = Il numero di telefono di recupero è stato rimosso dalle impostazioni di autenticazione in due passaggi.
postRemoveRecoveryPhone-description-extra = Puoi comunque utilizzare i codici di autenticazione di backup per accedere se non sei in grado di utilizzare l’app di autenticazione.

...
fxa-signup-error = Si è verificato un problema durante la creazione del tuo account. Riprova più tardi.
...
new-user-existing-account-sign-in = Hai già un account, <a>accedi</a>

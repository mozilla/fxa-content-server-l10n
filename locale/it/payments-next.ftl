...
checkout-error-not-eligible = Non sei idoneo ad abbonarti a questo prodotto. Contatta il supporto per ricevere assistenza.
checkout-error-contact-support = Contatta il supporto per consentirci di aiutarti.

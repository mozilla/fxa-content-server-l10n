...
error-payment-method-banner-message-add-new-card = Aggiungi una nuova carta o metodo di pagamento per evitare interruzioni dei tuoi abbonamenti.
error-payment-method-banner-label-update-payment-method = Aggiorna metodo di pagamento
error-payment-method-expired-card = La carta è scaduta. Aggiungi una nuova carta o metodo di pagamento per evitare interruzioni del tuo abbonamento.
...
subscription-content-button-cancel-subscription-1 = Annulla abbonamento

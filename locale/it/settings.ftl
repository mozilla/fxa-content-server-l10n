...
recent-activity-account-passkey-wrap-deleted = Accesso alla sincronizzazione con passkey rimosso
...
recent-activity-account-passkey-wrap-deletion-failure = Rimozione passkey sync access non riuscita

...
auth-error-202 = Caratteristica non attivata
...
signin-recovery-phone-instruction = È stato inviato un codice di sei cifre a <span>{ $maskedPhoneNumber }</span> tramite SMS. Questo codice scade dopo 5 minuti.

...
flow-setup-2a-qr-instruction = <strong>Passaggio 1:</strong> scansiona questo codice QR utilizzando qualsiasi app di autenticazione, come Duo o Google Authenticator.
...
flow-setup-2fa-qr-alt-text =
    .alt = Codice QR per impostare l’autenticazione in due passaggi. Scansionalo o scegli “Non riesci a scansionare il codice QR?” per ottenere una chiave segreta di installazione.
...
flow-setup-2fa-scan-qr-instead-button = Scegli scansione codice QR.

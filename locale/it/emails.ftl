...
lowRecoveryCodes-subject-2 =
    { $numberRemaining ->
        [0] Nessun codice di autenticazione di backup disponibile
        [one] È rimasto solo 1 codice di autenticazione di backup
...
postRemoveRecoveryPhone-subject = Il telefono per il recupero dell’account è stato rimosso
...
verifySecondaryCode-action-2 = Verifica indirizzo email
# Variables:

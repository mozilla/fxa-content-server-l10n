...
fxa-signup-error = Wystąpił problem podczas tworzenia konta. Proszę spróbować ponownie później.
...
new-user-existing-account-sign-in = Masz już konto, <a>zaloguj się</a>

...
location-required-header = Wybierz swój kraj i wprowadź kod pocztowy.
location-required-subheader = Nie udało nam się automatycznie wykryć Twojej lokalizacji.

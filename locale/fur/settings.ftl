...
signin-recovery-phone-instruction-v2 = Al è stât mandât un codiç di sîs cifris a <span>{ $maskedPhoneNumber }</span> midiant SMS. Chest codiç al scjât dopo 5 minûts. No sta condividi chest codiç cun nissun.

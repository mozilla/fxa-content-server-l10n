...
subscription-content-promotion-applied-no-tax = { $promotionName } voucher applied: { $invoiceTotal }
subscription-content-promotion-applied-with-tax = { $promotionName } voucher applied: { $invoiceTotal } + { $taxDue } tax

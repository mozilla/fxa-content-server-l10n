...
passwordChangeRequired-suspicious-activity = Nus avain constatà in cumportament suspectus en tes conto da Firefox. Per impedir l'access nunautorisà a tes conto da Firefox avain nus deconnectà tut tes apparats da tes conto e sco mesira da 
passwordChangeRequired-sign-in = T'annunzia danovamain sin in dals apparats tar in dals servetschs nua che ti utiliseschas tes conto da Firefox e suonda ils pass che ta vegnan preschentads.
...
postAddAccountRecovery-description = Ti has generà cun success ina clav da recuperaziun per tes conto da Firefox cun agid dal suandant apparat:
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = Autentificaziun en dus pass activada
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = Ti has activà cun success l'autentificaziun en dus pass per tes conto da Firefox. A partir dad ussa è necessari per mintga annunzia in code da segirezza furnì da tia applicaziun d'autentificaziun.
postAddTwoStepAuthentication-description = Ti has activà cun success l'autentificaziun en dus pass per tes conto da Firefox cun agid da suandant apparat:
...
postRemoveAccountRecovery-description = Ti has stizzà cun success ina clav da recuperaziun per tes conto da Firefox cun agid da suandant apparat:
...
postRemoveTwoStepAuthentication-description = Ti has deactivà cun success l'autentificaziun en dus pass per tes conto da Firefox cun agid da suandant apparat:
postRemoveTwoStepAuthentication-description-plaintext = Ti has deactivà cun success l'autentificaziun en dus pass per tes conto da Firefox. A partir dad ussa n'è betg pli necessari in code da segirezza per mintga annunzia.
postRemoveTwoStepAuthentication-action = { manage-account }
postVerify-sub-title = Verifitgà il conto da Firefox. Ti has quasi finì.
...
verificationReminderFirst-title = Bainvegni en la famiglia da Firefox
verificationReminderFirst-description = Avant in pèr dis has ti creà in conto da Firefox, ma ti n'al has mai confermà.
...
verificationReminderSecond-description = Avant bunamain ina emna has ti creà in conto da Firefox, ma n'al has mai verifitgà. Nus ans faschain quitads per tai.

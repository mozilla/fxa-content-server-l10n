...
credit-card-ending-in = Carta { $cardName } che chala cun { $lastFour }
...
unknown-card-ending-in = Carta nunenconuschenta che chala cun { $lastFour }
# Variables:
#  $invoiceNumber (String) - The invoice number of the subscription invoice, e.g. 8675309
...
postChangeAccountRecovery-body-part1 = Ti has ussa ina nova clav da recuperaziun dal conto. Ti clav precedenta è vegnida stizzada.

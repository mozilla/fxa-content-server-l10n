...
flow-setup-2fa-qr-heading = Meitsje ferbining mei jo authenticator-app
flow-setup-2a-qr-instruction = <strong>Stap 1:</strong> scan dizze QR-koade mei in authenticator-app, lykas Duo of Google Authenticator.
...
flow-setup-2fa-manual-key-instruction = <strong>Stap 1:</strong> fier dizze koade yn de authenticator-app fan jo foarkar yn.

...
subscription-management-error-apple-pay = Es gibt ein Problem mit Ihrem Konto { -brand-apple-pay }. Bitte lösen Sie das Problem, um Ihre aktiven Abonnements zu erhalten.
subscription-management-error-google-pay = Es gibt ein Problem mit Ihrem Konto { -brand-google-pay }. Bitte lösen Sie das Problem, um Ihre aktiven Abonnements zu erhalten.
subscription-management-error-link = Es gibt ein Problem mit Ihrem Konto { -brand-link }. Bitte lösen Sie das Problem, um Ihre aktiven Abonnements zu erhalten.

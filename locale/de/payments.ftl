...
new-user-subscribe-product-updates-mozilla = Ich möchte Neuigkeiten zu Produkten und Updates von { -brand-mozilla } erhalten
new-user-subscribe-product-updates-snp = Ich möchte Neuigkeiten und Updates zu Sicherheit und Datenschutz von { -brand-mozilla } erhalten

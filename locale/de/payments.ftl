...
sub-next-bill-no-tax-1 = Die nächste Rechnung von { $priceAmount } ist am { $date } fällig
sub-next-bill-tax-1 = Die nächste Rechnung über { $priceAmount } + { $taxAmount } Steuern ist am { $date } fällig

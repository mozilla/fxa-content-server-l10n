...
signin-recovery-phone-instruction-v2 = Ein 6-stelliger Code wurde per SMS an <span>{ $maskedPhoneNumber }</span> gesendet. Dieser Code läuft nach 5 Minuten ab und soll nicht weitergegeben werden.

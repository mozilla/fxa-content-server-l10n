...
signin-recovery-phone-instruction-v2 = Ein sechsstelliger Code wurde per SMS an <span>{ $maskedPhoneNumber }</span> gesendet. Dieser Code läuft nach 5 Minuten ab. Geben Sie diesen Code an niemanden weiter.

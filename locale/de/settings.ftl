...
recovery-key-file-key-value-v2 = Schlüssel: { $recoveryKeyValue }
...
recovery-key-file-download-date-v2 = * Schlüssel erzeugt: { $downloadDate }
# Link to get more information and support
# { $supportUrl } will be a URL such as https://mzl.la/3bNrM1I
# The URL will not be hyperlinked and will be presented as plain text in the downloaded file
recovery-key-file-support-v2 = * Weitere Informationen über Ihren Kontowiederherstellungsschlüssel: { $supportURL }
...
flow-recovery-key-hint-message-v3 = Dieser Hinweis sollte Ihnen dabei helfen, sich zu merken, wo Sie Ihren Kontowiederherstellungsschlüssel gespeichert haben. Wir können es Ihnen während des Zurücksetzens des Passworts anzeigen, um Ihre Daten wiederherzustellen.

...
passkey-sub-row-sign-in-only = Nur Anmeldung möglich. Kann nicht für Synchronisierung verwendet werden.
...
passkey-row-header = Hauptschlüssel
passkey-row-enabled = Aktiviert
passkey-row-not-set = Nicht festgelegt
passkey-row-action-create = Erstellen
passkey-row-description = Machen Sie die Anmeldung einfacher und sicherer, indem Sie Ihr Telefon oder ein anderes unterstütztes Gerät für Ihr Konto verwenden.

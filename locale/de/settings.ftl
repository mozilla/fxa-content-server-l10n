...
flow-setup-2fa-qr-alt-text =
    .alt = QR-Code zum Einrichten der Zwei-Schritt-Authentifizierung. Scannen Sie es oder wählen Sie „Sie können den QR-Code nicht scannen?“. , um stattdessen einen Setup-Geheimschlüssel zu erhalten.

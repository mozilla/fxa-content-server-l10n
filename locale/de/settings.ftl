...
promo-qr-mobile-qr-alt =
    .alt = QR-Code zum Herunterladen der mobilen App { -brand-firefox }. Positionieren Sie die Kamera Ihres Telefons in der unteren rechten Ecke des Bildschirms, um sie zu scannen.

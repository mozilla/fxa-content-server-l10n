...
passkey-row-webauthn-not-supported = เบราว์เซอร์หรืออุปกรณ์ของคุณไม่รองรับพาสคีย์
...
passkey-registration-error-not-supported = ที่นี่ไม่รองรับพาสคีย์ โปรดลองใช้วิธีอื่นหรืออุปกรณ์อื่นแทน
...
passkey-authentication-error-not-supported = ไม่รองรับพาสคีย์ โปรดลองใช้วิธีอื่นหรืออุปกรณ์อื่น
...
pair-choice-subheader = ซิงก์ข้อมูล { -brand-firefox } ของคุณ
...
set-password-heading-v2 = สร้างรหัสผ่านเพื่อซิงก์
...
signin-passkey-fallback-heading = ป้อนรหัสผ่านของคุณเพื่อซิงก์

...
passwordChangeRequired-suspicious-activity-2 = เราตรวจพบพฤติกรรมที่น่าสงสัยใน{ -product-mozilla-account } ของคุณ เพื่อป้องกันการเข้าถึง{ -product-mozilla-account } ของคุณโดยไม่ได้รับอนุญาต เราได้ตัดการเชื่อมต่ออุปกรณ์ทั้งหมดในบัญชีของคุณและจำเป็นต้องให้คุณเปลี่ยนรหัสผ่านเพื่อป้องกันไว้ก่อนล่วงหน้า
passwordChangeRequired-sign-in-2 = ลงชื่อกลับเข้าสู่อุปกรณ์หรือบริการใด ๆ ที่คุณใช้{ -product-mozilla-account } ของคุณ และทำตามขั้นตอนที่คุณเห็น
...
password-forgot-otp-code = ถ้าใช่ ให้ใส่รหัสยืนยันดังต่อไปนี้เพื่อดำเนินการต่อ:
...
passwordResetAccountRecovery-action-3 = สร้างคีย์กู้คืนบัญชี
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionPaymentExpired-subject-1 = บัตรเครดิตสำหรับ % (productName)s หมดอายุแล้ว หรือกำลังจะหมดอายุ
...
# $productPaymentCycleOld (String) - The interval of time from the end of one payment statement date to the next payment statement date of the old subscription, e.g. month
# $paymentProrated (String) - The one time fee to reflect the higher charge for the remainder of the payment cycle, including currency, e.g. $10.00
subscriptionUpgrade-content-charge-info-different-cycle = คุณจะถูกเรียกเก็บค่าธรรมเนียมเพียงครั้งเดียวจำนวน { $PaymentProrated } เพื่อให้สอดคล้องกับราคาที่สูงขึ้นของการสมัครสมาชิกของคุณสำหรับส่วนที่เหลือของ { $productPaymentCycleOld } เริ่มตั้งแต่การเรียกเก็บเงินครั้งถัดไป การเรียกเก็บเงินของคุณจะเปลี่ยนจากจำนวน { $PaymentAmountOld } ต่อ{ $productPaymentCycleOld } เป็นจำนวน { $PaymentAmountNew } ต่อ{ $productPaymentCycleNew }
# Variables:
# $productName (String) - The name of the new subscribed product, e.g. Mozilla VPN
...
verifyLoginCode-subject-line-2 = อนุมัติการลงชื่อเข้า { $serviceName }
# Variables:
#  $serviceName (String) - A service the user hasn't signed into before (e.g. Firefox)

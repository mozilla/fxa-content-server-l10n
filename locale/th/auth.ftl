...
subscriptionAccountReminderFirst-content-info = เมื่อไม่กี่วันก่อน คุณได้สร้าง{ -product-firefox-account } แต่ยังไม่เคยยืนยันเลย เราหวังว่าคุณจะตั้งค่าบัญชีของคุณให้เสร็จสิ้น เพื่อให้คุณสามารถใช้การสมัครสมาชิกใหม่ของคุณได้
subscriptionAccountReminderFirst-content-select = เลือก “สร้างรหัสผ่าน” เพื่อตั้งค่ารหัสผ่านใหม่และยืนยันบัญชีของคุณให้เสร็จ
...
subscriptionAccountReminderSecond-content-info = เมื่อไม่กี่วันก่อน คุณได้สร้าง{ -product-firefox-account } แต่ยังไม่เคยยืนยันเลย เราหวังว่าคุณจะตั้งค่าบัญชีของคุณให้เสร็จสิ้น เพื่อให้คุณสามารถใช้การสมัครสมาชิกใหม่ของคุณได้
subscriptionAccountReminderSecond-content-select = เลือก “สร้างรหัสผ่าน” เพื่อตั้งค่ารหัสผ่านใหม่และยืนยันบัญชีของคุณให้เสร็จ
...
subscriptionCancellation-content = เราได้ยกเลิกการสมัครสมาชิก { $productName } ของคุณแล้ว การชำระเงินครั้งสุดท้ายจำนวน { $invoiceTotal } ของคุณได้จ่ายแล้วเมื่อ{ $invoiceDateOnly } บริการของคุณจะยังคงใช้ได้ต่อไปจนกระทั่งสิ้นสุดระยะเวลาการเรียกเก็บเงินปัจจุบันของคุณ ซึ่งตรงกับ { $serviceLastActiveDateOnly }
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionsPaymentExpired-subject = บัตรเครดิตสำหรับการสมัครสมาชิกของคุณจะหมดอายุในไม่ช้า
subscriptionsPaymentExpired-title = บัตรเครดิตของคุณกำลังจะหมดอายุ
subscriptionsPaymentExpired-content = บัตรเครดิตที่คุณกำลังจะใช้ชำระเงินสำหรับการสมัครสมาชิกต่อไปนี้กำลังจะหมดอายุ

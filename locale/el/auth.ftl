...
subscriptionCancellation-freeTrial-content = Η δωρεάν δοκιμή του { $productName } έχει ακυρωθεί. Η πρόσβασή σας θα λήξει στις { $trialEndDateOnly }. Δεν θα χρεωθείτε.
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN

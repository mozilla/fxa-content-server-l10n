...
banner-warning-message = Οι δημιουργοί προσθέτων του { -brand-firefox } έγιναν πρόσφατα στόχοι επιθέσεων ηλεκτρονικού «ψαρέματος» μέσω ηλεκτρονικού ταχυδρομείου. Θα στέλνουμε email σχετικά με τον { -product-mozilla-account(case: "acc", capitalization: "lower") } σας από το <a data-l10n-name="accountsEmailLink">{ $accountsEmail }</a>.

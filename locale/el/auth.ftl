...
passwordChangeRequired-suspicious-activity = Εντοπίσαμε ύποπτη συμπεριφορά στο λογαριασμό Firefox σας. Για να αποτρέψουμε τη μη εξουσιοδοτημένη πρόσβαση, αποσυνδέσαμε όλες τις συσκευές του λογαριασμού σας και σας ζητούμε να αλλάξετε τον κωδικό
passwordChangeRequired-sign-in = Συνδεθείτε ξανά σε οποιαδήποτε συσκευή ή υπηρεσία, όπου χρησιμοποιείτε το λογαριασμό Firefox σας και ακολουθήστε τα βήματα που θα σας παρουσιαστούν.
...
postAddAccountRecovery-description = Έχετε δημιουργήσει επιτυχώς ένα κλειδί ανάκτησης για το λογαριασμό Firefox σας από την ακόλουθη συσκευή:
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = Η ταυτοποίηση δύο παραγόντων ενεργοποιήθηκε
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = Έχετε ενεργοποιήσει επιτυχώς την ταυτοποίηση δύο παραγόντων στον λογαριασμό Firefox σας. Θα απαιτείται πλέον κωδικός ασφαλείας από την εφαρμογή πιστοποίησής σας σε κάθε σύνδεση.
postAddTwoStepAuthentication-description = Έχετε ενεργοποιήσει επιτυχώς την ταυτοποίηση δύο παραγόντων στον λογαριασμό Firefox σας από την ακόλουθη συσκευή:
...
postRemoveAccountRecovery-description = Έχετε αφαιρέσει επιτυχώς ένα κλειδί ανάκτησης για το λογαριασμό Firefox σας από την ακόλουθη συσκευή:
...
postRemoveTwoStepAuthentication-description = Έχετε απενεργοποιήσει επιτυχώς την ταυτοποίηση δύο παραγόντων στον λογαριασμό Firefox σας από την ακόλουθη συσκευή:
postRemoveTwoStepAuthentication-description-plaintext = Έχετε απενεργοποιήσει επιτυχώς την ταυτοποίηση δύο παραγόντων στον λογαριασμό Firefox σας. Δεν θα απαιτείται πλέον κωδικός ασφαλείας σε κάθε σύνδεση.
postRemoveTwoStepAuthentication-action = { manage-account }
postVerify-sub-title = Ο λογαριασμός Firefox επαληθεύτηκε. Έχετε σχεδόν τελειώσει.
...
verificationReminderFirst-title = Καλώς ορίσατε στην οικογένεια Firefox
verificationReminderFirst-description = Πριν από λίγες ημέρες, δημιουργήσατε ένα λογαριασμό Firefox, αλλά δεν κάνατε ποτέ επιβεβαίωση.
...
verificationReminderSecond-description = Σχεδόν μια εβδομάδα πριν δημιουργήσατε ένα λογαριασμό Firefox, αλλά δεν τον επαληθεύσατε ποτέ. Ανησυχούμε για εσάς.

...
flow-setup-2fa-qr-heading = Cysylltwch â'ch app dilysu
...
flow-setup-2fa-qr-alt-text =
    .alt = Cod QR ar gyfer sefydlu dilysiad dau gam. Sganiwch ef, neu dewiswch “Methu sganio cod QR?” i gael allwedd gyfrinachol setup yn lle hynny.
flow-setup-2fa-cant-scan-qr-button = Methu â sganio cod QR?
flow-setup-2fa-manual-key-heading = Rhowch y cod â llaw
flow-setup-2fa-manual-key-instruction = <strong>Cam 1:</strong> Rhowch y cod hwn yn eich ap dilysu dewisol.
flow-setup-2fa-scan-qr-instead-button = Sganio cod QR yn lle?
...
flow-setup-2fa-backup-choice-description = Mae hyn yn caniatáu ichi fewngofnodi os na allwch gael mynediad i'ch dyfais symudol neu ap dilysu.
flow-setup-2fa-backup-choice-phone-title = Ffôn adfer
flow-setup-2fa-backup-choice-phone-badge = Hawsaf
flow-setup-2fa-backup-choice-phone-info = Cael cod adfer trwy neges destun. Ar gael ar hyn o bryd yn UDA a Chanada.
flow-setup-2fa-backup-choice-code-title = Codau dilysu wrth gefn
flow-setup-2fa-backup-choice-code-badge = Mwyaf diogel
flow-setup-2fa-backup-choice-code-info = Creu ac arbed codau dilysu un-tro.
# This link points to https://support.mozilla.org/kb/secure-mozilla-account-two-step-authentication
flow-setup-2fa-backup-choice-learn-more-link = Dysgwch am adferiad a risg cyfnewid SIM

## The backup code confirm step of the setup 2 factor authentication flow,
## where the user confirm that they have saved their backup authentication codes
## by entering one of them.

flow-setup-2fa-backup-code-confirm-heading = Rhowch god dilysu wrth gefn
# codes here refers to backup authentication codes
flow-setup-2fa-backup-code-confirm-confirm-saved = Cadarnhewch eich bod wedi cadw'ch codau trwy gynnig un. Heb y codau hyn, efallai na fyddwch yn gallu mewngofnodi os nad oes gennych eich ap dilysu.
...
flow-setup-2fa-backup-code-dl-save-these-codes = Cadwch y rhain mewn man y byddwch yn ei gofio. Os nad oes gennych chi fynediad i'ch ap dilysu bydd angen i chi nodi un i fewngofnodi.

...
password-forgot-otp-request = Cawsom gais am newid cyfrinair ar eich cyfrif { -product-mozilla-account } oddi wrth:
password-forgot-otp-code = Os ydych, dyma'ch cod cadarnhau i symud ymlaen:

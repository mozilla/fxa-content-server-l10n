...
error-payment-method-banner-label-update-payment-method = Diweddaru dull talu
error-payment-method-expired-card = Mae eich cerdyn wedi dod i ben. Ychwanegwch gerdyn neu ddull talu newydd i osgoi amharu ar eich tanysgrifiadau.
...
subscription-management-error-apple-pay = Mae problem gyda'ch cyfrif { -brand-apple-pay }. Datryswch y mater i gynnal eich tanysgrifiadau gweithredol.
subscription-management-error-google-pay = Mae problem gyda'ch cyfrif { -brand-google-pay }. Datryswch y mater i gynnal eich tanysgrifiadau gweithredol.
subscription-management-error-link = Mae problem gyda'ch cyfrif { -brand-link }. Datryswch y mater i gynnal eich tanysgrifiadau gweithredol.
...
subscription-management-error-payment-method = Mae problem gyda'ch dull talu. Datryswch y mater i gynnal eich tanysgrifiadau gweithredol.

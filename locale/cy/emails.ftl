...
automated-email-support = Am ragor o wybodaeth, ewch i'n <a data-l10n-name="supportLink">{ -brand-mozilla } Cefnogaeth</a>.
...
automated-email-support-plaintext = Am ragor o wybodaeth, ewch i'n { -brand-mozilla } Cefnogaeth:
...
lowRecoveryCodes-subject-2 =
    { $numberRemaining ->
        [0] Dim codau dilysu wrth gefn ar ôl
        [one] Dim ond 1 cod dilysu wrth gefn ar ôl
        [zero] Dim ond { $numberRemaining } cod dilysu wrth gefn ar ôl!
        [two] Dim ond { $numberRemaining } cod dilysu wrth gefn ar ôl!
        [few] Dim ond { $numberRemaining } cod dilysu wrth gefn ar ôl!
        [many] Dim ond { $numberRemaining } cod dilysu wrth gefn ar ôl!
...
passwordResetAccountRecovery-subject-2 = Mae eich cyfrinair wedi ei ailosod
...
postSigninRecoveryCode-device = Rydych chi wedi mewngofnodi o:
...
recovery-request-origin-2 = Rydym wedi derbyn cais i newid cyfrinair ar eich cyfrif { -product-mozilla-account } oddi wrth:
...
verifyAccountChange-preview =
    { $expirationTime ->
        ...
        [two] Daw'r cod hwn i ben ymhen { $expirationTime } munud
...
verifyAccountChange-expiry-notice =
    { $expirationTime ->
        ...
        [two] Daw i ben ymhen { $expirationTime } munud.
...
verifyLogin-subject-2 = Cadarnhau eich mewngofnodi
...
verifyPrimary-action-2 = E-bost cadarnhau
...
verifySecondaryCode-action-2 = E-bost cadarnhau
# Variables:

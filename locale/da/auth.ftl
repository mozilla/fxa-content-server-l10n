...
fxa-privacy-url = Mozillas privatlivspolitik
...
subplat-explainer-specific = Du modtager denne mail, fordi { $email } har en Firefox-konto, og du har tilmeldt dig { $productName }.
## Variables:
##  $email (String) - A user's primary email address
subplat-explainer-multiple = Du modtager denne mail, fordi { $email } har en Firefox-konto, og du har abonneret på flere produkter.
...
passwordChangeRequired-suspicious-activity = Vi har konstateret mistænkelig adfærd på din Firefox-konto. For at undgå uautoriseret adgang til din Firefox-konto, har vi afbrudt forbindelsen til alle enheder på din konto og kræver af 
passwordChangeRequired-sign-in = Log ind igen på en enheder eller tjeneste, hvor du bruger din Firefox-konto. Følg derefter de beskrevne trin.
...
postAddAccountRecovery-description = Du har oprettet en genoprettelsesnøgle til din Firefox-konto med følgende enhed:
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = Totrinsgodkendelse aktiveret
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = Du har aktiveret totrinsgodkendelse på din Firefox-konto. Sikkerhedskoder fra din godkendelsesapp vil nu være påkrævet ved hvert login.
postAddTwoStepAuthentication-description = Du har aktiveret totrinsgodkendelse på din Firefox-konto fra følgende enhed:
postAddTwoStepAuthentication-action = { manage-account }
postChangePrimary-subject = Primær mailadresse opdateret
postChangePrimary-title = Ny primær mailadresse
## Variables:
##  $email (String) - A user's email address
postChangePrimary-description = Du har ændret din primære mailadresse til { $email }. Den mailadresse er nu dit brugernavn, som du skal bruge til at logge ind på din Firefox-konto og til at modtage sikkerhedsmeddelelser og login-
...
postRemoveAccountRecovery-description = Du har fjernet en genoprettelsesnøgle til din Firefox-konto med følgende enhed:
postRemoveAccountRecovery-action = { manage-account }
postRemoveSecondary-subject = Sekundær mailadresse fjernet
postRemoveSecondary-title = { postRemoveSecondary-subject }
## Variables:
##  $secondaryEmail (String) - A user's email address
postRemoveSecondary-description = Du har fjernet { $secondaryEmail } som sekundær mailadresse fra din Firefox-konto. Sikkerhedsmeddelelser og login-bekræftelser vil ikke længere blive sendt til denne mailadresse.
...
postRemoveTwoStepAuthentication-description = Du har deaktiveret totrinsgodkendelse på din Firefox-konto fra følgende enhed:
postRemoveTwoStepAuthentication-description-plaintext = Du har deaktiveret totrinsgodkendelse på din Firefox-konto. Sikkerhedskoder vil ikke længere være påkrævet ved login.
postRemoveTwoStepAuthentication-action = { manage-account }
postVerify-sub-title = Firefox-konto bekræftet. Du er næsten klar.
postVerify-title = Synkroniser nu mellem dine enheder!
postVerify-description = Med privat synkronisering forbliver dine bogmærker, adgangskoder og andre Firefox-data de samme på alle dine enheder.
...
verificationReminderFirst-description = For et par dage siden oprettede du en Firefox-konto, men bekræftede den aldrig.
...
verificationReminderSecond-description = For næsten en uge siden oprettede du en Firefox-konto, men bekræftede den aldrig. Vi bliver helt bekymrede for dig...
...
verifySecondary-explainer = Fra følgende Firefox-konto kommer en forespørgsel om at bruge { $email } som sekundær mailadresse:
...
## Variables:
##  $email (string) A user's unverified secondary email address
verifySecondaryCode-explainer = Fra følgende Firefox-konto kommer en forespørgsel om at bruge { $email } som sekundær mailadresse:

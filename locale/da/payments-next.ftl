...
subscription-content-next-bill-excl-disc-with-tax = Næste regning på <strong>{ $nextInvoiceTotal } + afgift</strong> eksklusive rabatter forfalder den <strong>{ $nextBillDate }</strong>

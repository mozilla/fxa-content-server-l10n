...
new-user-subscribe-product-updates-mozilla = J’aimerais recevoir les actualités sur les produits de { -brand-mozilla }
new-user-subscribe-product-updates-snp = J’aimerais recevoir les actualités et les actualités de { -brand-mozilla } de { -brand-mozilla }
new-user-subscribe-product-updates-hubs = J’aimerais recevoir les actualités sur les produits et les actualités de { -product-mozilla-hubs } et { -brand-mozilla }
new-user-subscribe-product-updates-mdnplus = J’aimerais recevoir des actualités sur les produits et des actualités de { -product-mdn-plus } et { -brand-mozilla }

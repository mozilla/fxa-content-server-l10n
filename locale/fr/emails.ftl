...
lowRecoveryCodes-subject-2 =
    { $numberRemaining ->
        [0] Plus aucun code d’authentification de secours
        [one] Plus que 1 code d’authentification de secours restant
...
postAddRecoveryPhone-how-protect-plaintext = En quoi cela protège votre compte :
...
verifySecondaryCode-title-2 = Confirmer l’adresse secondaire

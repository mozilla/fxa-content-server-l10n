...
error-payment-method-banner-message-add-new-card = Ajoutez une nouvelle carte ou un nouveau mode de paiement pour éviter l’interruption de vos abonnements.
error-payment-method-banner-label-update-payment-method = Mettre à jour un mode de paiement
error-payment-method-expired-card = Votre carte a expiré. Veuillez ajouter une nouvelle carte ou un nouveau mode de paiement pour éviter l’interruption de vos abonnements.
...
subscription-management-error-apple-pay = Il y a un problème avec votre compte { -brand-apple-pay }. Veuillez résoudre le problème pour conserver vos abonnements actifs.
subscription-management-error-google-pay = Il y a un problème avec votre compte { -brand-google-pay }. Veuillez résoudre le problème pour conserver vos abonnements actifs.
subscription-management-error-link = Il y a un problème avec votre compte { -brand-link }. Veuillez résoudre le problème pour conserver vos abonnements actifs.
...
subscription-management-error-payment-method = Il y a un problème avec votre mode de paiement. Veuillez résoudre le problème pour conserver vos abonnements actifs.
...
subscription-content-button-cancel-subscription-1 = Annuler l’abonnement

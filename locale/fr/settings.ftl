...
passkey-sub-row-created-date = Créé : { $createdDate }
...
passkey-sub-row-sign-in-only = Connexion uniquement. Ne peut pas être utilisé pour synchroniser.
passkey-sub-row-delete-title = Supprimer la clé
...
passkey-delete-modal-confirm-button = Supprimer la clé
...
passkey-row-enabled = Activé
passkey-row-not-set = Non défini

...
flow-setup-2fa-qr-alt-text =
    .alt = Code QR pour configurer l’authentification en deux étapes. Scannez-le, ou choisissez « Vous ne pouvez pas scanner le code QR ? » pour obtenir une clé secrète d’installation à la place.
...
flow-setup-2fa-backup-choice-phone-info = Recevez un code de récupération par SMS. Actuellement disponible aux États-Unis et au Canada.
flow-setup-2fa-backup-choice-code-title = Codes d’authentification de secours
flow-setup-2fa-backup-choice-code-badge = La plus sûre
...
flow-setup-2fa-backup-code-dl-heading = Enregistrer les codes d’authentification de secours

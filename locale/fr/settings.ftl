...
password-strength-long-instruction = Choisissez un mot de passe fort que vous n’avez pas utilisé sur d’autres sites. Assurez-vous qu’il répond aux exigences de sécurité :

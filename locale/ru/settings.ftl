...
flow-setup-2fa-qr-alt-text =
    .alt = QR-код для настройки двухэтапной аутентификации. Отсканируйте его или выберите «Не удается отсканировать QR-код?» , чтобы получить секретный ключ настройки.

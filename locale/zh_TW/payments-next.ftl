...
free-trial-content-charge-info-with-tax-halfyear = 免費試用於 { $date } 結束後，將向您收取每半年 { $amount } + { $tax } 稅。
...
free-trial-content-charge-info-no-tax-halfyear = 免費試用於 { $date } 結束後，將向您收取每半年 { $amount }。

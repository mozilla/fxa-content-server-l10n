...
session-verify-send-push-title-2 = Iniciar sesión na túa { -product-mozilla-account }?
...
fxa-privacy-url = { -brand-mozilla } Política de privacidade
moz-accounts-privacy-url-2 = { -product-mozilla-accounts(capitalization: "uppercase") } Aviso de privacidade
moz-accounts-terms-url = { -product-mozilla-accounts(capitalization: "uppercase") } Condicións do servizo

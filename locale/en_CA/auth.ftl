...
passwordChangeRequired-suspicious-activity-2 = We detected suspicious behaviour on your { -product-mozilla-account }. To prevent unauthorized access to your { -product-mozilla-account }, we’ve disconnected all devices on your account and are requiring you to change your password as a precaution.

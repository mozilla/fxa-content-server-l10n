...
cs-disconnect-lost-advice-content =
    Оскільки ваш пристрій було втрачено або викрадено,
    щоб зберегти свою інформацію в безпеці, вам слід змінити пароль { -product-firefox-accounts }
    у налаштуваннях облікового запису. Вам також варто ознайомитися з інформацією виробника
    втраченого пристрою про віддалене стирання даних.
...
avatar-page-file-upload-error = Виникла проблема при вивантаженні зображення профілю
avatar-page-delete-error = Виникла проблема при видаленні аватару
...
delete-account-confirm-title = Ви під'єднали свій { -product-firefox-accounts } до продуктів { -brand-mozilla }, які забезпечують для вас захист і продуктивність в Інтернеті:
...
rk-cannot-verify-session = Шкода, але при перевірці вашого сеансу виникла проблема
...
tfa-row-cannot-verify-session = На жаль, при підтвердженні сеансу виникла проблема

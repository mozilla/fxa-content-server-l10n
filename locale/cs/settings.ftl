...
recovery-phone-promo-description = Nyní se můžete přihlásit pomocí jednorázového hesla přes SMS, pokud nemůžete použít aplikaci dvoufázového ověření.
...
flow-setup-2fa-qr-heading = Připojte se k ověřovací aplikaci
flow-setup-2a-qr-instruction = <strong>Krok 1:</strong> Naskenujte tento QR kód pomocí libovolné aplikace, jako je Duo nebo Google Authenticator.
...
flow-setup-2fa-qr-alt-text =
    .alt = QR kód pro nastavení dvoufázového ověřování. Naskenujte ho, nebo zvolte „Nemůžete naskenovat QR kód?“ .
flow-setup-2fa-cant-scan-qr-button = Nemůžete naskenovat QR kód?

...
inactiveAccountFinalWarning-preview = Přihlaste se a zachovejte si svůj účet
...
# $deletionDate - the date when the account will be deleted if the user does not take action to-reactivate their account
# This date will already be formatted with moment.js into Thursday, Jan 9, 2025 format
inactiveAccountFirstWarning-impact = Protože jste nebyli aktivní, bude dne <strong>{ $deletionDate }</strong> váš účet a vaše osobní data trvale smazána.
...
lowRecoveryCodes-subject-2 =
    { $numberRemaining ->
        [0] Žádné záložní ověřovací kódy
        [one] Zbývá pouze 1 záložní ověřovací kód
        [few] K dispozici { $numberRemaining } záložních ověřovacích kódů
...
password-forgot-otp-title = Zapomněli jste své heslo?
password-forgot-otp-request = Obdrželi jsme žádost o změnu hesla k vašemu { -product-mozilla-account(case: "dat") } z:
...
postChangeAccountRecovery-action = Správa účtu
...
postVerify-action-2 = Připojit další zařízení
...
recovery-title-2 = Zapomněli jste své heslo?

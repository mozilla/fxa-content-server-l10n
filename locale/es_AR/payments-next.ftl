...
subscription-management-error-apple-pay = Hay un problema con su cuenta de { -brand-apple-pay }. Resuelva el problema para mantener sus suscripciones activas.
subscription-management-error-google-pay = Hay un problema con su cuenta de { -brand-google-pay }. Resuelva el problema para mantener sus suscripciones activas.
subscription-management-error-link = Hay un problema con su cuenta de { -brand-link }. Resuelva el problema para mantener sus suscripciones activas.
...
subscription-management-error-payment-method = Hay un problema con tu método de pago. Resuelva el problema para mantener sus suscripciones activas.

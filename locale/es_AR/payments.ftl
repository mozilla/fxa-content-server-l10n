...
sub-update-acknowledgment = Tu plan cambiará de inmediato y hoy se te cobrará una cantidad prorrateada por el resto de este ciclo de facturación. A partir del { $startingDate } se te cobrará el importe total.

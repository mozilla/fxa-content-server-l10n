...
flow-setup-2fa-qr-heading = Conectarse a su aplicación de autenticación
...
flow-setup-2fa-qr-alt-text =
    .alt = Código QR para configurar la autenticación en dos pasos. Escanéalo o seleccioná “¿No se puede escanear el código QR?” para obtener una clave secreta de instalación en su lugar.
flow-setup-2fa-cant-scan-qr-button = ¿No puede escanear el código QR?
...
flow-setup-2fa-step-2-instruction = <Strong>Paso 2:</strong>Ingrese el código de su aplicación de autenticación.
...
flow-setup-2fa-backup-choice-description = Esto le permite iniciar sesión si no puede acceder a su dispositivo móvil o aplicación de autenticación.
...
flow-setup-2fa-backup-code-dl-save-these-codes = Guárdalos en un lugar que puedas recordar. Si no tenés acceso a tu aplicación de autenticación, tenés que ingresar una para iniciar sesión.
...
tfa-enabled-v2 = Se habilitó la autenticación en dos pasos
tfa-scan-this-code =
...
inline-recovery-2fa-enabled-v2 = Se habilitó la autenticación en dos pasos

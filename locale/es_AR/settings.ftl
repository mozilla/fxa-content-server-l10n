...
auth-error-129 = El número de teléfono no es válido
...
auth-error-219 = Este número de teléfono se ha registrado con demasiadas cuentas. Pruebe con un número diferente.

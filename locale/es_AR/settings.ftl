...
ready-confirmation = Tu contraseña fue restablecida
...
reset-password-heading-w-custom-service = Restablecer la contraseña <span>para continuar con la configuración de la cuenta</span>

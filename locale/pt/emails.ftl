...
fxa-header-mozilla-logo = <img data-l10n-name="mozilla-logo" alt="logótipo da { -brand-mozilla }">
...
lowRecoveryCodes-subject-2 =
    { $numberRemaining ->
        [0] Não existem códigos de autenticação de recuperação remanescentes
...
verify-description-2 = Confirme a sua conta e aproveite ao máximo a { -brand-mozilla } em todos os sítios em que iniciar sessão, começando com:
...
verifyLogin-action = Confirmar início de sessão
# Variables:
#  $code (String) - The confirmation code for sign-in

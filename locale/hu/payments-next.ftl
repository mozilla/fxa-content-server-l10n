...
error-payment-method-banner-message-add-new-card = Adjon hozzá új kártyát vagy fizetési módot, hogy elkerülje az előfizetések megszakításait.
error-payment-method-banner-label-update-payment-method = Fizetési mód frissítése
error-payment-method-expired-card = A kártyája lejárt. Kérjük, adjon hozzá új kártyát vagy fizetési módot, hogy elkerülje az előfizetések megszakítását.
...
subscription-management-error-apple-pay = Probléma van a(z) { -brand-apple-pay } fiókjával. Oldja meg a problémát, hogy megtartsa az aktív előfizetéseit.
subscription-management-error-google-pay = Probléma van a(z) { -brand-google-pay } fiókjával. Oldja meg a problémát, hogy megtartsa az aktív előfizetéseit.
subscription-management-error-link = Probléma van a(z) { -brand-link } fiókjával. Oldja meg a problémát, hogy megtartsa az aktív előfizetéseit.

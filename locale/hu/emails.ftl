...
lowRecoveryCodes-subject-2 =
    { $numberRemaining ->
        [0] Nem maradt tartalék hitelesítési kód
        [one] Csak 1 tartalék hitelesítési kód maradt
...
recovery-request-origin-2 = A { -product-mozilla-account }ja jelszavának megváltoztatására vonatkozó kérést kaptunk a következőtől:
...
verifySecondaryCode-title-2 = Másodlagos e-mail megerősítése

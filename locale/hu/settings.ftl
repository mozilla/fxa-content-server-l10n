...
flow-setup-2fa-qr-heading = Csatlakozzon a hitelesítő alkalmazáshoz
flow-setup-2a-qr-instruction = <strong>1. lépés:</strong> Olvassa be ezt a QR-kódot bármely hitelesítő alkalmazással, például a Duo vagy a Google Authenticator segítségével.

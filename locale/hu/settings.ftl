...
flow-recovery-key-hint-message-v2 = Ez a tipp segít megjegyezni, hogy hol tárolta a fiók-helyreállítási kulcsot. Meg fogjuk jeleníteni Önnek, ha az adatai helyreállításához használja.

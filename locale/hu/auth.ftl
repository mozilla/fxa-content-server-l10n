...
credit-card-ending-in = { $lastFour } végződésű { $cardName } kártya
...
unknown-card-ending-in = { $lastFour } végződésű ismeretlen kártya
# Variables:
#  $invoiceNumber (String) - The invoice number of the subscription invoice, e.g. 8675309
...
cadReminderFirst-description-v2 = Vigye át lapjait az összes eszköze között. Vigye magával a könyvjelzőit, jelszavait és egyéb adatait mindenhová, ahol a { -brand-firefox }ot használja.
...
password-forgot-otp-request = A(z) { -product-mozilla-account }ja jelszavának megváltoztatására vonatkozó kérést kaptunk a következőtől:

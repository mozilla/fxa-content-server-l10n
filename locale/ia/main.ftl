...
payment-zip =
    .label = Codice postal
payment-confirm-with-legal-links-static = Io autorisa { -brand-name-mozilla }, creator del productos de { -brand-name-firefox }, a debitar le amonta monstrate usante le methodo de pagamento de mi preferentia, conformemente al <termsOfServiceLink>conditiones de servicio</termsOfServiceLink> e al <privacyNoticeLink>aviso de confidentialitate</privacyNoticeLink>, usque io cancella mi subscription.

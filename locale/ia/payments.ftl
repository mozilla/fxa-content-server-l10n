...
sub-next-bill-no-tax-1 = Le factura successive de { $priceAmount } es debite { $date }
sub-next-bill-tax-1 =
    Le factura successive de { $priceAmount } + taxa de { $taxAmount } es debite { $date }
    { $priceAmount } es debite { $date }

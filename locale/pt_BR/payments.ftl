...
sub-next-bill-no-tax-1 = A próxima fatura de { $priceAmount } vence em { $date }
sub-next-bill-tax-1 = A próxima fatura de { $priceAmount } + { $taxAmount } de imposto vence em { $date }

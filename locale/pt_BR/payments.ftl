...
sub-update-acknowledgment = Seu plano mudará imediatamente, e será cobrado hoje um valor proporcional ao restante deste ciclo de faturamento. A partir de { $startingDate } será cobrado o valor total.

...
signin-recovery-phone-instruction-v2 = Um código de 6 dígitos foi enviado por SMS para <span>{ $maskedPhoneNumber }</span>. Expira em 5 minutos. Não compartilhe com ninguém.

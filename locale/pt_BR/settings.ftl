...
signin-recovery-phone-instruction-v2 = Um código de 6 dígitos foi enviado para <span>{ $maskedPhoneNumber }</span> via mensagem de texto. Expira em 5 minutos. Não compartilhe com ninguém.

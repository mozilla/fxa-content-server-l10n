...
flow-recovery-key-hint-message-v2 = Deze hint helpt u herinneren waar u uw accountherstelsleutel hebt opgeslagen. We tonen hem als u een herstelsleutel gebruikt om uw gegevens te herstellen.

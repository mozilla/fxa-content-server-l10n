...
fxa-privacy-url = Mozilla-privacybeleid
...
subplat-explainer-specific = U ontvangt dit bericht omdat { $email } een Firefox-account heeft en u bent ingeschreven voor { $productName }.
## Variables:
##  $email (String) - A user's primary email address
subplat-explainer-multiple = U ontvangt dit bericht omdat { $email } een Firefox-account heeft en u bent geabonneerd op meerdere producten.
...
passwordChangeRequired-suspicious-activity = We hebben verdacht gedrag in uw Firefox-account gedetecteerd. Om ongeoorloofde toegang tot uw Firefox-account te voorkomen, hebben we alle apparaten in uw account ontkoppeld en u dient uit voorzorg 
passwordChangeRequired-sign-in = Meld u opnieuw aan op een van de apparaten of services waar u uw Firefox-account gebruikt en volg de gepresenteerde stappen.
...
postAddAccountRecovery-description = U hebt met succes een sleutel voor accountherstel voor uw Firefox-account gegenereerd via het volgende apparaat:
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = Authenticatie in twee stappen ingeschakeld
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = U hebt authenticatie in twee stappen op uw Firefox-account ingeschakeld. Vanaf nu zijn bij elke aanmelding beveiligingscodes vanaf uw authenticatie-app vereist.
postAddTwoStepAuthentication-description = U hebt authenticatie in twee stappen op uw Firefox-account ingeschakeld vanaf het volgende apparaat:
...
postChangePrimary-description = U hebt uw primaire e-mailadres met succes naar { $email } gewijzigd. Dit adres is nu uw gebruikersnaam voor het aanmelden bij uw Firefox-account, evenals voor het ontvangen van beveiligingsmeldingen 
...
postRemoveAccountRecovery-description = U hebt met succes een sleutel voor accountherstel voor uw Firefox-account verwijderd via het volgende apparaat:
postRemoveAccountRecovery-action = { manage-account }
postRemoveSecondary-subject = Secundair e-mailadres verwijderd
postRemoveSecondary-title = { postRemoveSecondary-subject }
## Variables:
##  $secondaryEmail (String) - A user's email address
postRemoveSecondary-description = U hebt { $secondaryEmail } met succes als secundair e-mailadres van uw Firefox-account verwijderd. Beveiligingsmeldingen en aanmeldingsbevestigingen worden niet meer op dit adres afgeleverd.
...
postRemoveTwoStepAuthentication-description = U hebt authenticatie in twee stappen op uw Firefox-account uitgeschakeld vanaf het volgende apparaat:
postRemoveTwoStepAuthentication-description-plaintext = U hebt authenticatie in twee stappen op uw Firefox-account uitgeschakeld. Vanaf nu zijn bij elke aanmelding geen beveiligingscodes meer vereist.
postRemoveTwoStepAuthentication-action = { manage-account }
postVerify-sub-title = Firefox-account geverifieerd. U bent bijna klaar.
postVerify-title = Het volgende: synchroniseren tussen uw apparaten!
postVerify-description = Sync houdt op persoonlijke wijze uw bladwijzers, wachtwoorden en andere Firefox-gegevens op al uw apparaten hetzelfde.
...
verificationReminderFirst-title = Welkom bij de Firefox-familie
verificationReminderFirst-description = U hebt enkele dagen geleden een Firefox-account aangemaakt, maar dit nooit bevestigd.
...
verificationReminderSecond-description = U hebt bijna een week geleden een Firefox-account aangemaakt, maar nooit geverifieerd. We maken ons zorgen om u.
...
verify-title = Activeer de Firefox-productfamilie
...
verifySecondary-explainer = Er is een aanvraag voor het gebruik van { $email } als tweede e-mailadres gedaan vanaf de volgende Firefox-account:
...
## Variables:
##  $email (string) A user's unverified secondary email address
verifySecondaryCode-explainer = Er is een aanvraag voor het gebruik van { $email } als tweede e-mailadres gedaan vanaf de volgende Firefox-account:

...
tfa-enabled-v2 = Dwójokšacowa awtentifikacija jo se zmóžniła
...
tfa-enter-code-to-confirm-setup = Zapódajśo kod, aby wobkšuśił, až sćo składł swóje kody. Bźez toś tych kodow njamóžośo se snaź pśizjawiś, jolic swójo autentifikaciske nałoženje njamaśo.
...
inline-recovery-2fa-enabled-v2 = Dwójokšacowa awtentifikacija jo se zmóžniła
...
confirm-recovery-code-reset-password-input-label = 10-městnowy kod zapódaś
confirm-recovery-code-reset-password-trouble-code = Slědk
...
signin-recovery-phone-instruction = Šesćměstnowy kod jo se pósłał pśez tekstowu powěsć na <span>{ $maskedPhoneNumber }</span>. Toś ten kod za 5 minutow spadnjo.

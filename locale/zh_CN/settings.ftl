...
recovery-key-file-key-value-v2 = 恢复密钥：{ $recoveryKeyValue }
...
recovery-key-file-download-date-v2 = * 恢复密钥已生成：{ $downloadDate }
# Link to get more information and support
# { $supportUrl } will be a URL such as https://mzl.la/3bNrM1I
# The URL will not be hyperlinked and will be presented as plain text in the downloaded file
recovery-key-file-support-v2 = * 账户恢复密钥的更多信息：{ $supportURL }
...
flow-recovery-key-hint-message-v2 = 此提示应该可以帮助您记住账户恢复密钥的位置。当您使用它来恢复数据时，我们会显示此提示。

...
passwordChangeRequired-suspicious-activity = 我们监测到您的 Firefox 账户存在可疑行为。为了防止他人未经授权访问您的账户，我们已断开该账户下所有设备的连接，并要求您更改密码。
passwordChangeRequired-sign-in = 请到常用设备或服务中重新登录 Firefox 账户，并按照所显示步骤进行操作。
...
postAddAccountRecovery-description = 您已使用下列设备，成功生成新的 Firefox 账户救援密钥：
postAddAccountRecovery-action = { manage-account }
postAddTwoStepAuthentication-subject = 已启用两步验证
postAddTwoStepAuthentication-title = { postAddTwoStepAuthentication-subject }
postAddTwoStepAuthentication-description-plaintext = 您已成功启用 Firefox 账户的两步验证。现在起，每次登录时都会需要您输入身份验证应用上的安全码。
postAddTwoStepAuthentication-description = 您已成功用下列设备启用 Firefox 账户的两步验证：
...
postRemoveAccountRecovery-description = 您已使用下列设备，成功移除 Firefox 账户救援密钥：
...
postRemoveTwoStepAuthentication-description = 您已成功用下列设备禁用 Firefox 账户的两步验证：
postRemoveTwoStepAuthentication-description-plaintext = 您已成功禁用 Firefox 账户的两步验证。现在起，无需安全码即可登录。
postRemoveTwoStepAuthentication-action = { manage-account }
postVerify-sub-title = Firefox 账户验证完毕，就快完成了。
...
verificationReminderFirst-title = 欢迎来到 Firefox 大家庭
verificationReminderFirst-description = 几天前您创建了 Firefox 账户，但未进行确认。
...
verificationReminderSecond-description = 大约一周前，您创建了一个 Firefox 账户却未进行验证。我们对此表示担忧。

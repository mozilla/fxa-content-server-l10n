...
checkbox-confirm-free-trial-with-legal-links = 我授权 { -brand-mozilla } 在免费试用期结束后于 { $endDate } 依照<termsOfServiceLink>服务条款</termsOfServiceLink>和<privacyNoticeLink>隐私声明</privacyNoticeLink>，向我的付款方式收取此费用，直到我主动取消订阅为止。

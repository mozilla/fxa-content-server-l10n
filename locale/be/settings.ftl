...
recovery-key-download-button = Сцягнуць ваш ключ аднаўлення
    .title = Сцягнуць
...
progress-bar-aria-label = Індыкатар выканання, які паказвае, што карыстальнік знаходзіцца на кроку { $currentStep } з { $numberOfSteps }.
